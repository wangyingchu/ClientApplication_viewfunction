require([
    ...
    "dojo/text!vfbam/userclient/components/enterpriseInfoManagement/widget/userPreview/template/UserPreviewWidget.html"
],function(lang,declare, _Widget, _Templated, template){
    declare("vfbam.userclient.components.enterpriseInfoManagement.widget.userPreview.UserPreviewWidget", [_Widget, _Templated], {
        ...
        postCreate: function(){
            ...
            this.renderUserPreviewEventHandler=
                Application.MessageUtil.listenToMessageTopic(APP_ENTERPRISE_USERINFOSELECTED_EVENT,dojo.hitch(this, "renderUserInfoPreview"));
        },
        renderUserInfoPreview:function(eventPayload){
            ...
            this.userFacePhoto.src=
                PARTICIPANT_SERVICE_ROOT+"participantOperationService/userInfo/facePhoto/"+"enterpiseInfo"+"/"+userDetailInfo.userId+"?timestamp="+dateTimeStamp;
            this.userName.innerHTML=userDetailInfo.displayName;
            this.userId.innerHTML=userDetailInfo.userId;

            var roleTypeDisplayName=APPLICATION_ENTERPRISE_DISPLAYNAME_MAP[userDetailInfo.roleType];
