require([
    ...
    "dojo/text!vfbam/userclient/components/enterpriseInfoManagement/widget/template/ParticipantProfileEditorWidget.html","idx/oneui/Dialog"
],function(lang,declare, _Widget, _Templated, template,Dialog){
    declare("vfbam.userclient.components.enterpriseInfoManagement.widget.ParticipantProfileEditorWidget", [_Widget, _Templated], {
        ...
        postCreate: function(){
        	if(this.participantId){
        		...
        		this.facePhotoPath=PARTICIPANT_SERVICE_ROOT+"participantOperationService/userInfo/facePhoto/"+"enterpiseInfo"+"/"+this.participantId+"?timestamp="+dateTimeStamp;
        ...
        _doUpdateUserProfile:function(){
            ...
            userProfileData.participantScope= "enterpiseInfo";
        ...
        updateUserFacePhoto:function(){
        	var userPhotoUploadWidget=new vfbam.userclient.common.UI.components.participantProfile.ParticipantFacePhotoUploaderWidget({participantId:this.participantId,
                participantProfileEditor:this,callback:this.updatePhotoCallback,participantSpace:"enterpiseInfo"});
