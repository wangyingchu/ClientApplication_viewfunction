define({      
	...
	waiSingleSortLabel: "${0} - está classificado por ${1}. Escolher classificar por ${2}",
	waiNestedSortLabel:"${0} - está aninhado classificado por ${1}. Escolher aninhar classificação por ${2}"
});
