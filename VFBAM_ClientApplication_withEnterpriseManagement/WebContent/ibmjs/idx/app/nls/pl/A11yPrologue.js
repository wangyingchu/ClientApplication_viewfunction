...
//begin v1.x content
	...
	keySequence_Chrome: "ALT plus ${accessKey} w systemie Windows i Linux lub CONTROL plus OPT w systemie Mac",
	shortcutListMessage: "Skróty dostępu do tej strony są następujące:",
	a11yPrologueLabel: "Prolog na temat ułatwień dostępu",
    a11yStatementLabel: "Oświadczenie dotyczące ułatwień dostępu",
	...
	shortcutKeyMessage_external: "Aby dowiązać do ${description}, użyj ${keySequence}.",
	shortcutMessage_internal: "Pomiń i przejdź do ${description}.",
	shortcutMessage_external: "Dowiąż do ${description}.",
