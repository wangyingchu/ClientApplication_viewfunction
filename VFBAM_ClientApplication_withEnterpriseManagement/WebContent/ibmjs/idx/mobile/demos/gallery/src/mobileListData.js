...
function(lang, connect, dom, domClass, registry, ItemFileWriteStore, iconUtils, TabBar, TabBarButton, RoundRectDataList) {
	lang.getObject("idx.mobile.demos.gallery.src.mobileLists", true);
	idx.mobile.demos.gallery.src.mobileLists = function() {
		var static_data = { 
			items: [ 
				{label: "Apple"},
				{label: "Banana"},
		...
		var _store1 = new ItemFileWriteStore({url: "gallery/data/dataList.json", clearOnClose: true});
