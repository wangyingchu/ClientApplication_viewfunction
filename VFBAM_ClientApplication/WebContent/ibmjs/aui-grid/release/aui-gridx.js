	...
	module.directive('auiGridCell', ['GridUtil', function(GridUtil) {
		...
		return {
			...
			link: function($scope, $elem, $attrs, controllers) {
				...
				if (col.decorator && angular.isFunction(col.decorator)) {
					data = col.decorator(data);
				}
			...
			link: function($scope, $elem, $attrs, controllers) {
				...
				function buildHeader() {
					...
					angular.forEach(grid._columns, function(col) {
						...
						// console.log('style is', temp.style);
				...
				$elem.on('click', function(evt) {
					...
					colId = headerCell.getAttribute('colId');
	...
	module.directive('auiGrid', ['GridUtil', function(GridUtil) {
		return {
			...
			link: function($scope, $elem) {
				...
				$scope.$watch(
					function() { return grid.domNode.clientHeight; },
					function(nv, ov) { if (ov !== nv) grid.renderVLayout(); }
				);
			}
		};
	}]);
...
.factory('GridCore', ['GridUtil', '$q', 'Model', '$compile', '$parse', '$timeout', function(GridUtil, $q, Model){
	...
	GridCore.prototype = {
		...
		_init: function() {
			...
			t.registerApi('core', 'resize', hitch(t, t.resize));
...
angular.module('aui.grid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('aui-grid/aui-grid-footer',
    "<div class=\"gridxFooter\"><!-- \t<div class=\"gridxHScroller\">\r" +
    "\n" +
  ...
  $templateCache.put('aui-grid/aui-grid-header',
    "<div class=\"gridxHeader\" role=\"presentation\"><div class=\"gridxHeaderRow\"><div class=\"gridxHeaderRowInner\" role=\"row\" ng-class=\"{hasVScroller: grid.hasVScroller}\"><table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tbody><tr><td ng-repeat=\"cell in headerCells\" aria-readonly=\"true\" role=\"gridcell\" tabindex=\"-1\" aria-describedby=\"grid-id\" colid=\"{{cell.colId}}\" class=\"gridxCell {{cell.domClass}}\" ng-style=\"{{cell.style}}\" ng-class=\"{sortable: cell.sortable}\"><div class=\"gridxSortnode\" ng-class=\"{gridxSortDown: cell.sorting < 0, gridxSortUp: cell.sorting > 0}\">{{cell.content}}<div role=\"presentation\" tabindex=\"0\" class=\"gridxArrowButtonNode gridxArrowUp\" ng-show=\"cell.sorting > 0\"><div class=\"gridxArrowButtonChar\">&#9652;</div></div><div role=\"presentation\" tabindex=\"0\" class=\"gridxArrowButtonNode gridxArrowDown\" ng-show=\"cell.sorting < 0\"><div class=\"gridxArrowButtonChar\">&#9662;</div></div></div></td></tr></tbody></table></div></div></div>"
  );
  ...
  $templateCache.put('aui-grid/aui-grid',
    "<div class=\"gridx gridxDesktop\" role=\"grid\" tabindex=\"0\" aria-readonly=\"true\" aria-label=\"grid\"><div class=\"gridxLoad\"></div><div aui-grid-header></div><div aui-grid-body></div><div aui-grid-footer></div><span tabindex=\"0\"></span></div>"
  );
