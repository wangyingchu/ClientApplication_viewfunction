	...
	return {
		init: function(){
			...
			progressIndicatorStateImpl = function(v){
				...
				var elem = registry.byId("progressIndicator1d");
				progressIndicatorArray.push(elem);
				elem = registry.byId("progressIndicator2d");
				progressIndicatorArray.push(elem);
				elem = registry.byId("progressIndicator3d");
				progressIndicatorArray.push(elem);
				elem = registry.byId("progressIndicator4d");
				progressIndicatorArray.push(elem);
