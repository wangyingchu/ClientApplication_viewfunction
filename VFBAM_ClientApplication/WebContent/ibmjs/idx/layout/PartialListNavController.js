...
define([
	...
	"dijit/_base/wai",             // dojo_wai
    "dojo/_base/array",            // dojo_array
	"idx/layout/ListNavController" // idx_layout_ListNavController
	], function(dojo_declare, dijit_wai, dojo_array, idx_layout_ListNavController){
 ...
 * 
 */
return dojo_declare("idx.layout.PartialListNavController", idx_layout_ListNavController,
