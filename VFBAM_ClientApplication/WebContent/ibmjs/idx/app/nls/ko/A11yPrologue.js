...
//begin v1.x content
    ...
    skipToLocationMessage: "${description}(으)로 건너뛰기",
	shortcutKeyMessage_internal: "${description}(으)로 건너뛰려면 ${keySequence}을(를) 사용하십시오.",
	shortcutKeyMessage_external: "${description}에 링크하려면 ${keySequence}을(를) 사용하십시오.",
	shortcutMessage_internal: "${description}(으)로 건너뛰기.",
	shortcutMessage_external: "${description}에 링크.",

	a11yMainContentAreaName: "기본 컨텐츠",

	a11yNavigationAreaName: "탐색",

	a11yBannerAreaName: "배너"
//end v1.x content
});
