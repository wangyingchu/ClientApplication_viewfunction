...
//begin v1.x content
    ...
    skipToLocationMessage: "跳至 ${description}",
	shortcutKeyMessage_internal: "要跳至 ${description}，请使用 ${keySequence}。",
	shortcutKeyMessage_external: "要连接到 ${description}，请使用 ${keySequence}。",
	shortcutMessage_internal: "跳至 ${description}。",
	shortcutMessage_external: "链接到 ${description}。",

	a11yMainContentAreaName: "主要内容",

	a11yNavigationAreaName: "导航",

	a11yBannerAreaName: "条幅"
//end v1.x content
});
