...
//begin v1.x content
	...
	shortcutKeyMessage_internal: "使用 ${keySequence} 跳至${description}。",
	shortcutKeyMessage_external: "使用 ${keySequence} 鏈結至${description}。",
	shortcutMessage_internal: "跳至 ${description}。",
	shortcutMessage_external: "鏈結至 ${description}。",

	a11yMainContentAreaName: "主要內容",

	a11yNavigationAreaName: "導覽",

	a11yBannerAreaName: "橫幅"
//end v1.x content
});
