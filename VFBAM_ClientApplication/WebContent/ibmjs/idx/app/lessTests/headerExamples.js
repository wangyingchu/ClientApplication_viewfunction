...
define(["idx/app/Header", "dojo/_base/lang", "idx/widget/Menu", "dijit/MenuItem", "idx/widget/MenuBar", "dijit/MenuBarItem", "dijit/PopupMenuBarItem", "dijit/layout/StackContainer", "dijit/layout/ContentPane"],
...
//START
		...
		var header = new Header({
			...
			contextActions: [{
				label: "Action 1",
				onClick: function(e){ alert('Context action 1 button clicked'); }
			}, {
				label: "Action 2",
				onClick: function(e){ alert('Context action 2 button clicked'); }
			}, {
...
//START
		...
		var header = new Header({
			...
			layoutType: "fixed",
			showNavigationDropDownArrows: false,
			showUserDropDownArrow: false,
			showSettingsDropDownArrow: false,
			showHelpDropDownArrow: false
		},
		__id__);
		header.startup();
//END
