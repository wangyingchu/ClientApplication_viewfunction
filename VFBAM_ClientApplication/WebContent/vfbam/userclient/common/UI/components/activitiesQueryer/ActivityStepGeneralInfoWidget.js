require([
    ...
    "dojo/text!vfbam/userclient/common/UI/components/activitiesQueryer/template/ActivityStepGeneralInfoWidget.html",
    "dojo/dom-class","idx/oneui/Dialog"
],function(lang,declare, _Widget, _Templated, template,domClass,Dialog){
    declare("vfbam.userclient.common.UI.components.activitiesQueryer.ActivityStepGeneralInfoWidget", [_Widget, _Templated], {
        ...
        postCreate: function(){
            ...
            */
            ...
            if(this.activityStepData.finishTime>0){
                var stepDueDateStr=dojo.date.locale.format(new Date(this.activityStepData.finishTime));
