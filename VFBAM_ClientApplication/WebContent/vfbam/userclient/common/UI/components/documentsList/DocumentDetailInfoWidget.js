require([
    ...
    "dojo/text!vfbam/userclient/common/UI/components/documentsList/template/DocumentDetailInfoWidget.html","dijit/popup"
],function(lang,declare, _Widget, _Templated, template,popup){
    declare("vfbam.userclient.common.UI.components.documentsList.DocumentDetailInfoWidget", [_Widget, _Templated], {
        ...
        renderDocumentPreview:function(documentInfo,documentsOwnerType,documentExtalInfo){
            ...
            if(documentInfo.isFolder){
                ...
                this.documentSizeText.innerHTML= documentInfo.childDocumentNumber;
            }else{
                var num;
                var fileSize;
            ...
            if(documentInfo.documentCreator){
                var documentCreatorParticipantInfo={};
                documentCreatorParticipantInfo.participantPhotoPath=PARTICIPANT_SERVICE_ROOT+"participantOperationService/userInfo/facePhoto/"+APPLICATION_ID+"/"+ this.documentInfo.documentCreator.userId;
                documentCreatorParticipantInfo.participantId=this.documentInfo.documentCreator.userId;
                documentCreatorParticipantInfo.participantName=this.documentInfo.documentCreator.displayName;
                documentCreatorParticipantInfo.participantTitle=this.documentInfo.documentCreator.title;
                documentCreatorParticipantInfo.participantPhone=this.documentInfo.documentCreator.fixedPhone;
                documentCreatorParticipantInfo.participantEmail=this.documentInfo.documentCreator.emailAddress;
                documentCreatorParticipantInfo.participantDesc=this.documentInfo.documentCreator.description;
                documentCreatorParticipantInfo.participantAddress=this.documentInfo.documentCreator.address;
                this.creatorNamecardWidget=
                    new vfbam.userclient.common.UI.components.participantsList.ParticipantNamecardWidget({participantInfo:documentCreatorParticipantInfo});
                this.documentCreatorText.set("label",documentCreatorParticipantInfo.participantName);
            ...
            if(documentInfo.isFolder){
                ...
                if(documentInfo.documentLastUpdatePerson){
                    ...
                    documentLastModifiedParticipantInfo.participantPhotoPath=PARTICIPANT_SERVICE_ROOT+"participantOperationService/userInfo/facePhoto/"+APPLICATION_ID+"/"+ this.documentInfo.documentLastUpdatePerson.userId;
                    documentLastModifiedParticipantInfo.participantId=this.documentInfo.documentLastUpdatePerson.userId;
                    documentLastModifiedParticipantInfo.participantName=this.documentInfo.documentLastUpdatePerson.displayName;
                    documentLastModifiedParticipantInfo.participantTitle=this.documentInfo.documentLastUpdatePerson.title;
                    documentLastModifiedParticipantInfo.participantPhone=this.documentInfo.documentLastUpdatePerson.fixedPhone;
                    documentLastModifiedParticipantInfo.participantEmail=this.documentInfo.documentLastUpdatePerson.emailAddress;
                    documentLastModifiedParticipantInfo.participantDesc=this.documentInfo.documentLastUpdatePerson.description;
                    documentLastModifiedParticipantInfo.participantAddress=this.documentInfo.documentLastUpdatePerson.address;
                    ...
                    this.documentLastUpdatePersonText.set("label",documentLastModifiedParticipantInfo.participantName);
