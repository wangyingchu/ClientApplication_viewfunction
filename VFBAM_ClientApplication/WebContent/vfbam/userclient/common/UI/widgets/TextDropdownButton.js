define([
    ...
    "dijit/_Container",
    "idx/form/Link",
    "dojo/text!./template/TextDropdownButton.html"
    ...
    /**
     * @name vfbam.userclient.common.UI.widgets.TextDropdownButton
     * @class text with a drop-down menu.
     * @augments idx.form.Link
     * @augments dijit._Container
     * @augments dijit._HasDropDown
     */
    return dojo_declare("vfbam.userclient.common.UI.widgets.TextDropdownButton", [idx.form.Link, dijit_Container, dijit_HasDropDown], {
         ...
         * @private as part of widgets life cycle
         */
         startup: function() {
         ...
         /**
         * Gets drop down widgets from saved pointer to original DOM
         * @private
         */
         _getDropDown: function() {
            // find drop down widgets node
