...
define([
	...
	/**
	 * @private
	 * @name idx.layout.ToggleSplitter
	 * @class idx.layout.ToggleSplitter is an internal class only used by idx.layout.ToggleBorderContainer.
	 * User don't need to call its' API manually.
	 * @augments dijit.layout._Splitter
	 */
	return declare("idx.layout.ToggleSplitter", [dijit.layout._Splitter],
	/**@lends idx.layout.ToggleSplitter.prototype*/
	{
		// summary:
