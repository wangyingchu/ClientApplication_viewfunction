...
{
		/**
 		 * @name idx.widget.NavTreeModel
 		 * @class Provides an expanded ForestStoreModel to support the additional features of idx.widget.NavTree.
 		 * @augments dijit.tree/ForestStoreModel
 		 */
		return dDeclare("idx.widget.NavTreeModel",[dForestStoreModel], 
