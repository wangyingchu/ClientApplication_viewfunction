				 ...
				 templateText)		// (dojo/text!./templates/WorkspaceTab.html)	
{
	 ...
	 */
	return dDeclare("idx.app.WorkspaceTab",[dWidget,dTemplatedMixin],
...
{		
  ...
  startup: function() {
	    ...
	    var tabPanelID = null;
	    var titleNodeID = null;
	    if (this.titleNode) {
	    	titleNodeID = dDomAttr.get(this.titleNode, "id");
	    }
	    if ((this.workspace) && (this.workspace.domNode)) {
	    	tabPanelID = dDomAttr.get(this.workspace.domNode, "id")
	    	if (titleNodeID) dDomAttr.set(this.workspace.domNode, "aria-labelledby", titleNodeID);
	    }
	    if (tabPanelID && this.tabNode) {
