...
define(["dojo/_base/declare",
	 ...
	 * @example
	   ...
	   &lt;/div>
	 */
return dDeclare("idx.app.TabMenuLauncher",[iLauncher,dTemplatedMixin],
        /**@lends idx.app.TabMenuLauncher#*/	             
{
  ...
  */
  ...
  baseClass: "idxTabMenuLauncher",
	...
	/**
	 * The text for the widget template for the dijit._TemplatedMixin base class.
	 * @constant
	 * @type String
	 * @private
  ...
  /**
   * Extends base method by attaching to the onWorkspaceSelected
   * event to the private _onWorkspaceSelected method.
   */
  startup: function() {
    this.inherited(arguments);
    this.contentStack.startup();
    this.own(dAspect.after(
    			this.tabDock, "onWorkspaceSelected",
    			dLang.hitch(this, this._onWorkspaceSelected), true));
  ...
  _workspaceClosing: function(workspace) {
    this.tabDock._doRemoveWorkspace(workspace, (workspace == this._selectedWorkspace));
    this.contentStack.removeChild(workspace); 
